      ...
      <div className="flex h-[70vh] bg-white rounded-2xl border border-orange-100 shadow-sm overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto">
            {chats.length === 0 ? (
              <div className="p-6 text-center text-orange-300 text-sm">
                Sin chats aún
              </div>
            ) : (
              chats.map((chat) => (
        ...
        {active ? (
              ...
              {messages.map((msg) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {!isMe && (
                        <p className="font-semibold text-xs text-primary-600 mb-0.5">
                          {msg.sender_name}
                        </p>
                      )}
                      ...
                      <p
                        className={clsx(
                          'text-[10px] mt-1',
                          isMe ? 'text-primary-200' : 'text-orange-300'
                        )}
                      >
          ...
          <div className="flex-1 flex items-center justify-center">
            <EmptyState
              ...
              description="Elegí una conversación de la lista."
            />
          </div>
        )}
      </div>
