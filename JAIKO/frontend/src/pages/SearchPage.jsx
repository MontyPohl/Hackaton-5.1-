  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
          <h1 className="font-display font-extrabold text-3xl sm:text-4xl text-blue-950">Buscar Roomies</h1>
          <p className="text-orange-500 font-bold mt-1">{profiles.length} perfiles compatibles encontrados</p>
        </div>
